...
def generate_pdf(data):
    ...
    elements.append(Paragraph(f"Plan: {data['plan_type']}", styles["Normal"]))
...
async def submit_policy(
    ...
    if age < 18 or age > 75:
        return JSONResponse(
            status_code=400,
            content={"error": "Principal member must be between 18 and 75 years old."}
        )
    ...
    return {"message": "Policy submitted successfully.", "pdf": pdf_file}
